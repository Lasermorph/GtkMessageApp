...
{
	m_eventController = gtk_shortcut_controller_new();
	...
	gtk_shortcut_controller_add_shortcut(GTK_SHORTCUT_CONTROLLER(m_eventController), shortcut);
	gtk_widget_add_controller(window, m_eventController);
}
