...
ADW_FLAGS:=$(shell pkg-config --cflags libadwaita-1)
ADW_LINK:=$(shell pkg-config --libs libadwaita-1)

CUSTOM_INCLUDE:=-I./include

CXX_OPTIMIZE:=-g3

CXX_FLAGS:=$(CXX_OPTIMIZE) $(GTK4_FLAGS) $(ADW_FLAGS) $(CXX_VERSION) $(CUSTOM_INCLUDE)

CXX_LINK:=$(GTK4_LINK) $(ADW_LINK)
default: friendslist.o hotkeys.o actions.o typingfield.o superhandler.o messagefield.o topmenubar.o mainwindow.o main.o
